                        ...
                        <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                            <div class="p-5">
                                ...
                                <div class="flex flex-wrap items-center justify-between mb-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-full {{ $perf->isAutoGenerated() ? 'bg-green-100' : 'bg-gray-100' }} flex items-center justify-center text-sm font-bold {{ $perf->isAutoGenerated() ? 'text-green-700' : 'text-gray-600' }}">
                                        ...
                                        <div>
                                            <h4 class="font-bold text-gray-800">
                                                ...
                                                @endif
                                                @if($perf->isAutoGenerated())
                                                    <span class="ml-2 inline-flex items-center gap-1 px-2 py-0.5 text-xs rounded-full bg-green-100 text-green-700 font-semibold">
                                                        ⚡ Live Match — Auto
                                                    </span>
                                                @else
                                                    <span class="ml-2 inline-flex items-center gap-1 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-500 font-medium">
                                                        ✏️ Manual
                                                    </span>
                                                @endif
                                            </h4>
                                    ...
                                    @if($perf->isAutoGenerated())
                                        <span class="text-xs text-gray-400 italic">Auto-generated from live scoring</span>
                                    @else
